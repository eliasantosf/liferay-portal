...
const PolicyDetail = () => {
	const amountOfPoliceDetail = [0];
	const navbarLabel = ['Vehicles', 'Drives'];
	...
	return (
		<div className="policy-detail-container">
			...
			{amountOfPoliceDetail.map(
				(curentPoliceDetail, indexPoliceDetail) => (
					<div className="bg-neutral-0 p-6" key={indexPoliceDetail}>
						{active === 'Vehicles' && (
							<>
